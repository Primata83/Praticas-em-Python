print('Bem vindo A Loja de Açai e Cupuaçu do Hudson Cleiton de Paula')
print('--------------------CARDAPIO----------------------')
...
while True:
  sabor = input('Entre com o sabor do Açai ou Cupuaçu desejado (CP|AC)')
  ...
  if sabor != 'CP' and sabor != 'AC':
    ...
    continue  # bloco pede o sabor do ac/cp ou mostra mensagem de erro
  ...
  if tamanho != 'P' and tamanho != 'M' and tamanho != 'G':
    ...
    continue # bloco pede tamanho p/m/g ou mostra mensagem de erro
